...
import com.crystal.wx.common.MessageType;
...
public class MessageHandlerUtil {
    ...
    public static String buildXml(Map<String,String> map){
        ...
        if(msgType.equalsIgnoreCase("TEXT")){
            result=buildTextMessage(map,"碧海无波在学习和总结微信开发了，构造了一条文本消息：Hello World！");
        }else {
            String content="请回复如下关键词：\n文本\n图片\n语音\n视频\n音乐\n图文";
            result = buildTextMessage(map,content);
        }
    ...
    private static String handleTextMessage(Map<String,String> map){
        ...
        switch (content){
            case "文本":
                String messageText="碧海无波又要开始写博客总结了,欢迎朋友们访问我在博客园上面写的博客\n"+
                        "<a href=\"http://www.cnblogs.com/xqlcrystal\">碧海无波的博客</a>";
                responseMessage=buildTextMessage(map,messageText);
                break;
            case "图片":
                String imgMediaId="hz7rn5zJsVM4z-ZcUdOyOmuz9wTm0BShkD_l4eb8zJljn1NaTKeCWLomYhvEjJnP";
                responseMessage=buildImageMessage(map,imgMediaId);
                break;
            case "语音":
                String voiceMediaId="NDOKrl1mLZR_reOkIQ8DnQdkdiAd32fW0AGMcEun8tqkwaxNkC6sL2GwdK0CwoEC";
            ...
            case "音乐":
                ...
                music.musicUrl = "http://xql.tunnel.2bdata.com/media/music/music.mp3";
                music.hqMusicUrl = "http://xql.tunnel.2bdata.com/media/music/music.mp3";
                responseMessage = buildMusicMessage(map, music);
                break;
            case "视频":
                Video video = new Video();
                video.mediaId = "TuUwp1pvWo0vysCRfP1d8BC696X1e1eydtkQVWwyWS6PrER1tDHWn3tyhT_3PejL";
                video.title = "小苹果";
    ...
    private static String buildNewsMessage(Map<String, String> map) {
        ...
        item.Url = "http://www.cnblogs.com/xqlcrystal/p/5628902.html";
        ...
        item2.PicUrl = "";
        item2.Url = "http://www.cnblogs.com/xqlcrystal/p/5707339.html";
    ...
    private static String buildImageMessage(Map<String, String> map, String imgMediaId) {
        ...
        return String.format(
                "<xml>" +
                        ...
                        "</Image>" +
                        "</xml>",
                fromUserName, toUserName, getMessageCreateTime(), imgMediaId);
    }
    ...
    String content="感谢您关注我的个人公众号，请回复如下关键词来使用公众号提供的服务：\n文本\n图片\n语音\n视频\n音乐\n图文";
        return buildTextMessage(map,content);
    }
